...
local function CreateTextPanel()
    ...
    note:SetText("Name size applies to addon-controlled floating names and names above health bars. Inside-bar names use 80% of that size, rounded to the nearest point; the bar expands to leave one UI unit above and below. Blizzard-controlled overhead names have no nameplate frame to modify.")
...
local function CreateTRP3Panel()
    ...
    CreateOption("Show full title above the name", "showFullTitle")
